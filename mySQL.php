 ...
 * @access private
 */
var $connection = mysql_connect($dbhost, $dbusername, $dbpass);
if (!$connection) {
 ...
 * @access private
 */
var $dbcheck = mysql_select_db($dbname);
if (!$dbcheck) {
    die(mysql_error());
}
...
/**
 * The stringified boolen value for responce ajax request.
 *
 * @var array
 * @access private
 */
var $ajaxResponce = Array(
        true => 'success',
        false => 'fail'
    );
