 ...
 * @param {String} tag The selector.
 * @param {String} text The information to be display.
 */
...
/**
 * Generate advice and related graph and add to the advice page.
 * @method getAdvice
 */
function getAdvice() {
    $.ajax({
         ...
         * @event success
         * @param {String} responce The response from ajax call.
         */
...
$(document).ready(function(){
    ...
    /**
     * Bind the action on click the login button.
     * @event click
     */
    ...
    /**
     * Bind the action on click the register button.
     * @event click
     */
    ...
    /**
     * Bind the action on click the submit button.
     * @event click
     */
